...
<main class="flex-shrink-0" style="padding-top: 100px">
    <div class="container">
        <h1 class="mt-5">자주 묻는 질문 수정</h1>
        <p class="lead">자주 묻는 질문 수정 페이지입니다.</p>
        <hr>
        <form action="${pageContext.request.contextPath}/admin/faqUpdatePro" method="post"
            ...
            <input type="button" value="목록" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/faqList'">
        </form>
    </div>
</main>

  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
      ...
      <c:if test="${empty sessionScope.id}">
        <div class="login">
          <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='${pageContext.request.contextPath}/admin/adminLogin'">로그인</button>
        </div>
      </c:if>
      ...
      <c:if test="${!empty sessionScope.id}">
        <div class="login">
          ${sessionScope.id }님
          <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='${pageContext.request.contextPath}/admin/adminLogout'">로그아웃</button>
          <button type="button" class="btn btn-outline-primary" onclick="location.href='${pageContext.request.contextPath}/admin/adminMain'">관리자 페이지</button>
        </div>
      </c:if>

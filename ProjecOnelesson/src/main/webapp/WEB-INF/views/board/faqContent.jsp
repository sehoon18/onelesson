        ...
        <form action="${pageContext.request.contextPath}/board/faqInsertPro" method="post"
            ...
            <c:if test="${!empty sessionScope.id}">
            	<c:if test="${sessionScope.id == boardDTO.name}">
            		<input type="button" value="수정" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/faqUpdate?num=${adminBoardDTO.num}'">
            		<input type="button" value="삭제" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/faqDelete?num=${adminBoardDTO.num}'">
            	</c:if>
            </c:if>            
            
            <hr>
            <input type="button" value="목록" class="btn btn-primary" onclick="href='${pageContext.request.contextPath}/admin/faqList'">
        </form>
    </div>
</main>

        ...
        <form action="${pageContext.request.contextPath}/board/noticeInsertPro" method="post"
            ...
            <c:if test="${!empty sessionScope.id}">
            	<c:if test="${sessionScope.id == boardDTO.name}">
            		<button type="submit" class="btn btn-primary" onclick="href='${pageContext.request.contextPath}/board/noticeUpdate?num=${boardDTO.num}'">수정</button>
            		<button type="submit" class="btn btn-primary" onclick="href='${pageContext.request.contextPath}/board/noticeDelete?num=${boardDTO.num}'">삭제</button>
            	</c:if>
            </c:if>

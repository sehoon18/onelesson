...
<tr class="bg-primary" style="color: white;">
	...
	<c:if test="${memberDTO.type == 1 }"><th class="table-success">답변</th></c:if>
</tr>
<c:forEach var="boardDTO" items="${boardList}">
	...
	<c:if test="${memberDTO.type == 1 }"><td><button class="btn btn-success btn-sm" onclick="location.href='${pageContext.request.contextPath}/board/lessonQnaAnswer?num=${boardDTO.num}'">답변하기</button></td></c:if></tr>
</c:forEach>
</thead>
</table>
